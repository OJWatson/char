...
LC_model_ <- R6::R6Class(
  ...
  private = list(
    ...
    interpolate_t = NULL,
    cfuns = list(
      rhs_dde = "LC_model_rhs_dde",
      rhs_desolve = "LC_model_rhs_desolve",
      initmod_desolve = "LC_model_initmod_desolve",
      output_dde = "LC_model_output_dde"),
    dll = "char",
    ...
    registration = function() {
      if (FALSE) {
        .C("LC_model_rhs_dde", package = "char")
        .C("LC_model_rhs_desolve", package = "char")
        .C("LC_model_initmod_desolve", package = "char")
        .C("LC_model_output_dde", package = "char")
      }
    },

    ## This only does something in delay models
    set_initial = function(t, y, use_dde) {
      .Call("LC_model_set_initial", private$ptr, t, y, use_dde,
            PACKAGE= "char")
    },

    update_metadata = function() {
      meta <- .Call("LC_model_metadata", private$ptr,
                    PACKAGE = "char")
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
      ...
      private$ptr <- .Call("LC_model_create", user, PACKAGE = "char")
    ...
    ir = function() {
      path_ir <- system.file("odin/LC_model.json", mustWork = TRUE,
                             package = "char")
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      ...
      .Call("LC_model_set_user", private$ptr, user, PACKAGE = "char")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("LC_model_initial_conditions", private$ptr, t, PACKAGE = "char")
    },

    rhs = function(t, y) {
      .Call("LC_model_rhs_r", private$ptr, t, y, PACKAGE = "char")
    },
    ...
    contents = function() {
      .Call("LC_model_contents", private$ptr, PACKAGE = "char")
    },
...
LC_model <- function(..., user = list(...), use_dde = FALSE,
                     unused_user_action = NULL) {
  asNamespace("odin")$deprecated_constructor_call("LC_model")
  LC_model_$new(user = user, use_dde = use_dde,
                unused_user_action = unused_user_action)
}
class(LC_model) <- "odin_generator"
attr(LC_model, "generator") <- LC_model_
model_ <- R6::R6Class(
  "odin_model",
  cloneable = FALSE,
  ...
  private = list(
    ...
    dll = "char",
    user = c("AR0", "As0", "DR0", "Ds0", "Ev_r0", "Ev_s0", "Iv_r0", "Iv_s0",
             "TR0", "Ts0", "a", "b", "c_A", "c_D", "c_T", "e", "fT", "m",
             "mu", "n", "Phi", "rA", "rD", "rTR_true", "rTs", "S0", "Sv0",
             "toff", "ton"),
    ...
    registration = function() {
      if (FALSE) {
        .C("model_rhs_dde", package = "char")
        .C("model_rhs_desolve", package = "char")
        .C("model_initmod_desolve", package = "char")
        .C("model_output_dde", package = "char")
      }
    },
  ...
  public = list(
    initialize = function(..., user = list(...), use_dde = FALSE,
                          unused_user_action = NULL) {
      private$odin <- asNamespace("odin")
      private$ptr <- .Call("model_create", user, PACKAGE = "char")
      self$set_user(user = user, unused_user_action = unused_user_action)
      private$use_dde <- use_dde
      private$update_metadata()
    },
    ...
    set_user = function(..., user = list(...), unused_user_action = NULL) {
      private$odin$support_check_user(user, private$user, unused_user_action)
      .Call("model_set_user", private$ptr, user, PACKAGE = "char")
      private$update_metadata()
    },
    ...
    ## time in.
    initial = function(t) {
      .Call("model_initial_conditions", private$ptr, t, PACKAGE = "char")
    },

    rhs = function(t, y) {
      .Call("model_rhs_r", private$ptr, t, y, PACKAGE = "char")
    },
    ...
    contents = function() {
      .Call("model_contents", private$ptr, PACKAGE = "char")
    },
