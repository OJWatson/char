...
SEXP model_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 7, ScalarReal(internal->DR0));
  SET_VECTOR_ELT(contents, 8, ScalarReal(internal->Ds0));
  SET_VECTOR_ELT(contents, 9, ScalarReal(internal->e));
  SET_VECTOR_ELT(contents, 10, ScalarReal(internal->Ev_r0));
  SET_VECTOR_ELT(contents, 11, ScalarReal(internal->Ev_s0));
  SET_VECTOR_ELT(contents, 12, ScalarReal(internal->fT));
  SET_VECTOR_ELT(contents, 13, ScalarReal(internal->initial_AR));
  SET_VECTOR_ELT(contents, 14, ScalarReal(internal->initial_As));
  SET_VECTOR_ELT(contents, 15, ScalarReal(internal->initial_DR));
  SET_VECTOR_ELT(contents, 16, ScalarReal(internal->initial_Ds));
  SET_VECTOR_ELT(contents, 17, ScalarReal(internal->initial_Ev_r));
  SET_VECTOR_ELT(contents, 18, ScalarReal(internal->initial_Ev_s));
  SET_VECTOR_ELT(contents, 19, ScalarReal(internal->initial_Iv_r));
  SET_VECTOR_ELT(contents, 20, ScalarReal(internal->initial_Iv_s));
  SET_VECTOR_ELT(contents, 21, ScalarReal(internal->initial_S));
  SET_VECTOR_ELT(contents, 22, ScalarReal(internal->initial_Sv));
  SET_VECTOR_ELT(contents, 23, ScalarReal(internal->initial_TR));
  SET_VECTOR_ELT(contents, 24, ScalarReal(internal->initial_Ts));
  SET_VECTOR_ELT(contents, 25, ScalarReal(internal->Iv_r0));
  SET_VECTOR_ELT(contents, 26, ScalarReal(internal->Iv_s0));
  SET_VECTOR_ELT(contents, 27, ScalarReal(internal->m));
  SET_VECTOR_ELT(contents, 28, ScalarReal(internal->mu));
  SET_VECTOR_ELT(contents, 29, ScalarReal(internal->n));
  SET_VECTOR_ELT(contents, 30, ScalarReal(internal->Phi));
  SET_VECTOR_ELT(contents, 31, ScalarReal(internal->rA));
  SET_VECTOR_ELT(contents, 32, ScalarReal(internal->rD));
  SET_VECTOR_ELT(contents, 33, ScalarReal(internal->rTR_true));
  SET_VECTOR_ELT(contents, 34, ScalarReal(internal->rTs));
  SET_VECTOR_ELT(contents, 35, ScalarReal(internal->S0));
  SET_VECTOR_ELT(contents, 36, ScalarReal(internal->Sv0));
  SET_VECTOR_ELT(contents, 37, ScalarReal(internal->toff));
  SET_VECTOR_ELT(contents, 38, ScalarReal(internal->ton));
  SET_VECTOR_ELT(contents, 39, ScalarReal(internal->TR0));
  SET_VECTOR_ELT(contents, 40, ScalarReal(internal->Ts0));
  ...
  SET_STRING_ELT(nms, 7, mkChar("DR0"));
  SET_STRING_ELT(nms, 8, mkChar("Ds0"));
  SET_STRING_ELT(nms, 9, mkChar("e"));
  SET_STRING_ELT(nms, 10, mkChar("Ev_r0"));
  SET_STRING_ELT(nms, 11, mkChar("Ev_s0"));
  SET_STRING_ELT(nms, 12, mkChar("fT"));
  SET_STRING_ELT(nms, 13, mkChar("initial_AR"));
  SET_STRING_ELT(nms, 14, mkChar("initial_As"));
  SET_STRING_ELT(nms, 15, mkChar("initial_DR"));
  SET_STRING_ELT(nms, 16, mkChar("initial_Ds"));
  SET_STRING_ELT(nms, 17, mkChar("initial_Ev_r"));
  SET_STRING_ELT(nms, 18, mkChar("initial_Ev_s"));
  SET_STRING_ELT(nms, 19, mkChar("initial_Iv_r"));
  SET_STRING_ELT(nms, 20, mkChar("initial_Iv_s"));
  SET_STRING_ELT(nms, 21, mkChar("initial_S"));
  SET_STRING_ELT(nms, 22, mkChar("initial_Sv"));
  SET_STRING_ELT(nms, 23, mkChar("initial_TR"));
  SET_STRING_ELT(nms, 24, mkChar("initial_Ts"));
  SET_STRING_ELT(nms, 25, mkChar("Iv_r0"));
  SET_STRING_ELT(nms, 26, mkChar("Iv_s0"));
  SET_STRING_ELT(nms, 27, mkChar("m"));
  SET_STRING_ELT(nms, 28, mkChar("mu"));
  SET_STRING_ELT(nms, 29, mkChar("n"));
  SET_STRING_ELT(nms, 30, mkChar("Phi"));
  SET_STRING_ELT(nms, 31, mkChar("rA"));
  SET_STRING_ELT(nms, 32, mkChar("rD"));
  SET_STRING_ELT(nms, 33, mkChar("rTR_true"));
  SET_STRING_ELT(nms, 34, mkChar("rTs"));
  SET_STRING_ELT(nms, 35, mkChar("S0"));
  SET_STRING_ELT(nms, 36, mkChar("Sv0"));
  SET_STRING_ELT(nms, 37, mkChar("toff"));
  SET_STRING_ELT(nms, 38, mkChar("ton"));
  SET_STRING_ELT(nms, 39, mkChar("TR0"));
  SET_STRING_ELT(nms, 40, mkChar("Ts0"));
...
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double delayed_Lambda_v_r_Sv = Lambda_v_r * Sv * exp(-(internal->mu) * internal->n);
  double delayed_Lambda_v_s_Sv = Lambda_v_s * Sv * exp(-(internal->mu) * internal->n);
  dstatedt[5] = S * Lambda_R * (1 - internal->Phi) + DR * internal->rD - Lambda_R * AR * internal->Phi * (1 - internal->fT) - Lambda_R * AR * internal->Phi * internal->fT - AR * internal->rA;
  ...
  dstatedt[4] = S * Lambda_R * internal->Phi * (1 - internal->fT) + Lambda_R * AR * internal->Phi * (1 - internal->fT) - DR * internal->rD;
  ...
  dstatedt[6] = S * Lambda_R * internal->Phi * internal->fT + Lambda_R * AR * internal->Phi * internal->fT - TR * rTR;
